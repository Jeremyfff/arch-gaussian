...
from gui.contents.settings_content import UserSettingsContent, ProjectSettingsContent, ImguiSettingsContent
...
GUI_CONTENT_TYPES = Union[
    ...
    MainMenuContent,
    UserSettingsContent, ProjectSettingsContent, ImguiSettingsContent
]
